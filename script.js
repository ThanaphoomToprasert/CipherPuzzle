...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function submitGuess() {
        ...
        sendAttemptToResearchDB({
            guess: guess,
            feedback: feedback, // The array ['green', 'yellow', 'gray', ...]
            secret_code: secretCode, // So you know the target
            attempt_number: currentAttempt + 1 // So you know the sequence
        });
...
async function sendAttemptToResearchDB(data) {
    try {
        // This URL '/api/log' is a "relative" path.
        // It will point to your serverless function when you host it.
        await fetch('/api/log', {
            method: 'POST',
            headers: {
        ...
        // If the logging fails, the game still works for the player.
        // You can log this to the console for your own debugging.
